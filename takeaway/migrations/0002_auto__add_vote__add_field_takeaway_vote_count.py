...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TakeAway.vote_count'
        db.add_column(u'takeaway_takeaway', 'vote_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TakeAway.vote_count'
        db.delete_column(u'takeaway_takeaway', 'vote_count')
